#include <string.h>
#include <stdarg.h>     // Required for the error reroute

#include "esp_log.h"
#include "esp_system.h"
#include "esp_random.h" // The fix for esp_random()
#include "esp_wifi.h"   // The fix for raw wifi commands

#include "WifiBeacon.hpp"
#include "common.hpp"
#include "wifi_pkt.h"

// Reroute the old screen errors to the Serial Monitor
