...
void st7735_Init() {
    esp_rom_gpio_pad_select_gpio(ST7735_RESET_GPIO);
    esp_rom_gpio_pad_select_gpio(ST7735_AO_GPIO);
    esp_rom_gpio_pad_select_gpio(ST7735_CS_GPIO);
    ...
    esp_rom_gpio_pad_select_gpio(ST7735_BACKLIGHT_GPIO);
